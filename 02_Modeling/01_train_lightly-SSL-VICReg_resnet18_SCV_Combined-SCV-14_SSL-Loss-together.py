...
This script implements the self-supervised learning training pipeline using VICReg with ResNet18 backbone.
...
def main() -> None:
    """
    Main training function for VICReg with ResNet18 backbone.
    ...
    this_output_dir = output_dirs[patch_no] + '_' + architecture + '_' + validation_strategy + '_E' + str(num_epochs) + 'lightly-VICReg_kernel_size_' + str(kernel_size) + '_DS-' + str(patch_no)+ '_resnet-back_14fields_tuning'
